...
public class testJms {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("===================================");
        showMemoryInfo();
        System.out.println("================运行时操做系统==============");
        showSystem();
        System.out.println("================运行时类加载系统==============");
        showClassLoading();
        System.out.println("================虚拟机的编译系统===============");
        showCompilation();
        System.out.println("===============线程系统==========================");
        showThread();
    ...
    public static void showJvmInfo() {
        ...
        System.out.println("jvm vmVendor:"+mxBean.getVmVendor());
        System.out.println("jvm startTime:"+mxBean.getStartTime());
